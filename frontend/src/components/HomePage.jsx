        ...
        <Grid container spacing={7} alignItems='center'>
          ...
          <Grid item xs={6} color={{ color: 'var(--clr-primary-500)' }}>
            ...
            <Typography variant='subtitle1'>
              ...
              accusamus libero quo aspernatur qui voluptas natus dignissimos
              alias eveniet. Blanditiis hic doloribus temporibus accusantium
              iusto? Asperiores quia numquam alias architecto.
            </Typography>
